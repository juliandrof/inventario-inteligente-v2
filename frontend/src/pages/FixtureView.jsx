    ...
    <div className="page">
      ...
      <div className="card">
        <table className="data-table">
          <thead>
            <tr><th>Tipo</th><th>Arquivo</th><th>Data</th><th>Qtd</th><th>Descricao</th></tr>
          </thead>
          <tbody>
            {filtered.map((f, i) => (
              <tr key={i}>
                <td><span className="fixture-type-badge" style={{ background: TYPE_COLORS[f.fixture_type] || '#666' }}>{f.display_name || f.fixture_type}</span></td>
